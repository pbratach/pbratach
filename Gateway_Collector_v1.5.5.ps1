...
#   Version: 1.5.4 Modified Date: 26 June 2024
#     Add hostname to name of working folder and zip file
#   Version: 1.5.5 Modified Date: 16 August 2024
#     Add collection of database archive_state table and query "select * from properties order by k"
#     Add command "wmic cpu get /value" to get detailed CPU information
...
function GW-LOGS
{
	...
	Write-Output "Version 1.5.5" > "$basewfname\version.txt"

	Write-Output "*********************************************************"
	Write-Output "*** Ensure the Gateway_Collector_SQL_v1.5.5.sql file   **" 
...
# Create the Temp folder used for the MariaDB queries
	...
	foreach($line in Get-Content "Gateway_Collector_SQL_v1.5.5.sql" ) {
...
#				Write-Host "DEBUG: Extracted Query: $query3"
	...
	Write-Output "*******************************************************"
	Write-Output "********* Collecting detailed CPU Information *********"
	Write-Output "*******************************************************"
	Write-Output " "
	wmic cpu get /value >>"$basewfname\Windows\CPU_Detail_Information.txt"
